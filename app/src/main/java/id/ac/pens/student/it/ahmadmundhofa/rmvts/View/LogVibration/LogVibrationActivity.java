...
public class LogVibrationActivity extends AppCompatActivity {
    ...
    private List<Vibration> list = new ArrayList<>();
    private LogVibrationAdapter logVibrationAdapter;
    private RecyclerView.LayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_log_vibration);
    ...
    public void getDataLogVibration(String periode) {
        ...
        Call<ResponseModel> call = apiService.getLogVibration(token, periode);
        call.enqueue(new Callback<ResponseModel>() {
            @Override
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                DataResponse dataResponse = response.body().getData();
                list = dataResponse.getVibration();
                recyclerView.setHasFixedSize(true);
                logVibrationAdapter = new LogVibrationAdapter(list);
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(LogVibrationActivity.this);
                recyclerView.setLayoutManager(mLayoutManager);
                recyclerView.setItemAnimator(new DefaultItemAnimator());
                recyclerView.setAdapter(logVibrationAdapter);
                logVibrationAdapter.notifyDataSetChanged();
                dismissProgress();
            }
