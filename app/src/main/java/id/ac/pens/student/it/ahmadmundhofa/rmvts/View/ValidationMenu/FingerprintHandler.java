...
public class FingerprintHandler extends FingerprintManager.AuthenticationCallback {
    ...
    private void goToRemoteMenu() {
        TextView erorrText = (TextView) ((Activity)context).findViewById(R.id.errorText);
        ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) context, erorrText, "transition");
        int revealX = (int) (erorrText.getX() + erorrText.getWidth() / 2);
        int revealY = (int) (erorrText.getY() + erorrText.getHeight() / 2);
